	...
	return (
		<div className="flex flex-col items-center justify-center mt-32">
			...
			<div className="shrink-0 flex justify-center items-center mt-20">
				<div className="w-[309px] h-[262px] shrink-0 rounded-3xl bg-signUpBg shadow-xs flex flex-col justify-center items-center xl:w-[479px] xl:h-[262px]">
					<div className="w-[140px] h-[209px] shrink-0 flex flex-col items-center justify-between">
						...
						<button className="w-[260px] h-11 shrink-0 rounded-3xl bg-signInGradient flex items-center justify-center">
							<img className="w-9 h-8 shrink-0 opacity-90" src={signInLogo} />
							<div className="text-[#FFF] Inder text-sm font-normal">
								Sign Up with Particle Auth
							</div>
						</button>
